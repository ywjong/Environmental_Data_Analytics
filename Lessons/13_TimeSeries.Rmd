...
TempTest.auto <- lme(data = PeterPaul.summertemp,
                     ...
                     random = ~1|Week) #defining week of the year as random variable
TempTest.auto
#The output shows that there is about 1.58 of standard error across total weeks
ACF(TempTest.auto)
#We are interested in the second value (lag 1)
```
...
TempTest.mixed <- lme(data = PeterPaul.summertemp,
                     ...
                     #define method as restricted maximum likelihood, penalizes us for having more explanatory variables
                     method = "REML")
summary(TempTest.mixed)
#The sampledate coefficient means that every day will increase temperature by 0.000099 degree
#After multiplying that coefficient by 32 years and 365 days each year, the test shows that the lake increased temperature by 1.16 degree
...
#The p value shows that the mixed and fixed model provide significantly different fit
#fixed model has much higher AIC value than mixed model
