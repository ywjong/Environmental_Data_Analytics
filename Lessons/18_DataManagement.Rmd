...
Name <- webpage %>% html_nodes("td:nth-child(2)") %>% html_text() #generate html text
...
riverdata <- data_frame(Name = Name[6:188], 
...
riverdata$Name <- str_replace(riverdata$Name, "\\[.*\\]", "") # \\ means spaces before the [], .*\\ means anything within the bracket []
