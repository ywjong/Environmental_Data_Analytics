...
ui <- fluidPage(
   ...
   #The grammar of withMathJax is same with r markdown $$ equation, just that there are two backslash instead of one
...
server <- function(input, output) {
   ...
   output$dist <- renderPlot({ # adjust the number of bins based on the sample size
     ...
     #So when people change plot type, the data distribution will be the same
