...
```{r}
#4
ggplot(PeterPaulTidy, aes(y=tp_ug, x=po4,color = lakename)) +
  geom_point() +
  xlab("Phosphate") +
...
ggplot(PeterPaulGathered, aes(y=concentration, x=sampledate, color=depth))+
  geom_point()+
  facet_grid(PeterPaulGathered$nutrient)+
...
#6
library(gridExtra)
Plot1 <- ggplot(USGS.data,aes(x=datetime, y=X165986_00060_00001))+
  geom_point()+
  geom_line()

Plot2 <- ggplot(USGS.data,aes(x=datetime, y=X165986_00060_00001))+
  geom_point()+
  geom_smooth()
