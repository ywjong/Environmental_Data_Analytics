...
```{r}
#1 Sorry, I don't understand which files are the tidy and gathered referring to, so I might load the wrong file
PeterPaulTidy <- read.csv("./Data/Processed/NTL-LTER_Lake_ChemistryPhysics_PeterPaul_Processed.csv", header=T)
PeterPaulGathered <- read.csv("./Data/Processed/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv", header=T)
