...
```{r}
#generate sequence from 1 - 100 by intervals of 4
Numbers <- seq(1,100,4)
#Step 2
...
> ANSWER: Data frame is different from matrix in the sense that they have a header row that names each column and they show up at global environment as data instead of values
...
> ANSWER: ifelse worked, while if and else only displayed the results of first element because the vector has more than 1 element. Perhaps we need a for loop for that. Ifelse reminds me of the Con function in ArcGIS.
